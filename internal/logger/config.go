...
const (
	...
	EnvLoggerWebhookEnable        = "S3_LOGGER_WEBHOOK_ENABLE"
	EnvLoggerWebhookEndpoint      = "S3_LOGGER_WEBHOOK_ENDPOINT"
	EnvLoggerWebhookAuthToken     = "S3_LOGGER_WEBHOOK_AUTH_TOKEN"
	EnvLoggerWebhookClientCert    = "S3_LOGGER_WEBHOOK_CLIENT_CERT"
	EnvLoggerWebhookClientKey     = "S3_LOGGER_WEBHOOK_CLIENT_KEY"
	EnvLoggerWebhookProxy         = "S3_LOGGER_WEBHOOK_PROXY"
	EnvLoggerWebhookBatchSize     = "S3_LOGGER_WEBHOOK_BATCH_SIZE"
	EnvLoggerWebhookQueueSize     = "S3_LOGGER_WEBHOOK_QUEUE_SIZE"
	EnvLoggerWebhookQueueDir      = "S3_LOGGER_WEBHOOK_QUEUE_DIR"
	EnvLoggerWebhookMaxRetry      = "S3_LOGGER_WEBHOOK_MAX_RETRY"
	EnvLoggerWebhookRetryInterval = "S3_LOGGER_WEBHOOK_RETRY_INTERVAL"
	EnvLoggerWebhookHTTPTimeout   = "S3_LOGGER_WEBHOOK_HTTP_TIMEOUT"

	EnvAuditWebhookEnable        = "S3_AUDIT_WEBHOOK_ENABLE"
	EnvAuditWebhookEndpoint      = "S3_AUDIT_WEBHOOK_ENDPOINT"
	EnvAuditWebhookAuthToken     = "S3_AUDIT_WEBHOOK_AUTH_TOKEN"
	EnvAuditWebhookClientCert    = "S3_AUDIT_WEBHOOK_CLIENT_CERT"
	EnvAuditWebhookClientKey     = "S3_AUDIT_WEBHOOK_CLIENT_KEY"
	EnvAuditWebhookBatchSize     = "S3_AUDIT_WEBHOOK_BATCH_SIZE"
	EnvAuditWebhookQueueSize     = "S3_AUDIT_WEBHOOK_QUEUE_SIZE"
	EnvAuditWebhookQueueDir      = "S3_AUDIT_WEBHOOK_QUEUE_DIR"
	EnvAuditWebhookMaxRetry      = "S3_AUDIT_WEBHOOK_MAX_RETRY"
	EnvAuditWebhookRetryInterval = "S3_AUDIT_WEBHOOK_RETRY_INTERVAL"
	EnvAuditWebhookHTTPTimeout   = "S3_AUDIT_WEBHOOK_HTTP_TIMEOUT"

	EnvKafkaEnable        = "S3_AUDIT_KAFKA_ENABLE"
	EnvKafkaBrokers       = "S3_AUDIT_KAFKA_BROKERS"
	EnvKafkaTopic         = "S3_AUDIT_KAFKA_TOPIC"
	EnvKafkaTLS           = "S3_AUDIT_KAFKA_TLS"
	EnvKafkaTLSSkipVerify = "S3_AUDIT_KAFKA_TLS_SKIP_VERIFY"
	EnvKafkaTLSClientAuth = "S3_AUDIT_KAFKA_TLS_CLIENT_AUTH"
	EnvKafkaSASLEnable    = "S3_AUDIT_KAFKA_SASL"
	EnvKafkaSASLUsername  = "S3_AUDIT_KAFKA_SASL_USERNAME"
	EnvKafkaSASLPassword  = "S3_AUDIT_KAFKA_SASL_PASSWORD"
	EnvKafkaSASLMechanism = "S3_AUDIT_KAFKA_SASL_MECHANISM"
	EnvKafkaClientTLSCert = "S3_AUDIT_KAFKA_CLIENT_TLS_CERT"
	EnvKafkaClientTLSKey  = "S3_AUDIT_KAFKA_CLIENT_TLS_KEY"
	EnvKafkaVersion       = "S3_AUDIT_KAFKA_VERSION"
	EnvKafkaQueueDir      = "S3_AUDIT_KAFKA_QUEUE_DIR"
	EnvKafkaQueueSize     = "S3_AUDIT_KAFKA_QUEUE_SIZE"
