...
const (
	...
	EnvServerAddr         = "S3_IDENTITY_LDAP_SERVER_ADDR"
	EnvSRVRecordName      = "S3_IDENTITY_LDAP_SRV_RECORD_NAME"
	EnvTLSSkipVerify      = "S3_IDENTITY_LDAP_TLS_SKIP_VERIFY"
	EnvServerInsecure     = "S3_IDENTITY_LDAP_SERVER_INSECURE"
	EnvServerStartTLS     = "S3_IDENTITY_LDAP_SERVER_STARTTLS"
	EnvUsernameFormat     = "S3_IDENTITY_LDAP_USERNAME_FORMAT"
	EnvUserDNSearchBaseDN = "S3_IDENTITY_LDAP_USER_DN_SEARCH_BASE_DN"
	EnvUserDNSearchFilter = "S3_IDENTITY_LDAP_USER_DN_SEARCH_FILTER"
	EnvUserDNAttributes   = "S3_IDENTITY_LDAP_USER_DN_ATTRIBUTES"
	EnvGroupSearchFilter  = "S3_IDENTITY_LDAP_GROUP_SEARCH_FILTER"
	EnvGroupSearchBaseDN  = "S3_IDENTITY_LDAP_GROUP_SEARCH_BASE_DN"
	EnvLookupBindDN       = "S3_IDENTITY_LDAP_LOOKUP_BIND_DN"
	EnvLookupBindPassword = "S3_IDENTITY_LDAP_LOOKUP_BIND_PASSWORD"
)
