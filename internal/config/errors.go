...
var (
	...
	ErrInvalidErasureEndpoints = newErrFn(
		...
		"For more information, please refer to https://docs.hanzo.ai/community/minio-object-store/operations/concepts/erasure-coding.html",
	)
...
Examples:
   ...
   $ minio server /data-{1...4}/minio # Single Node Multi Drive`,
	...
	ErrNoCertsAndHTTPSEndpoints = newErrFn(
		...
		"Refer to https://docs.hanzo.ai/community/minio-object-store/operations/network-encryption.html for information about how to load a TLS certificate in your server",
	)
	...
	ErrUnexpectedError = newErrFn(
		"Unexpected error",
		"Please contact us at https://hanzo.ai/discord",
		"",
	)
